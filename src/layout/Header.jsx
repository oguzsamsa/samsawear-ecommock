      ...
      <div className="w-5/6 md:w-11/12 mx-auto flex justify-between py-6 text-[#252B42]">
        ...
        <div className="flex gap-6 items-center md:text-[#23A6F0] relative">
          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-80 bg-white border border-gray-300 shadow-lg p-4">
                {cart.length === 0 ? (
                  ...
                  <ul>
                    {cart.map((item) => (
                      <li
                        key={item.product.id}
                        className="flex items-start p-2 border-b border-gray-300"
                      >
                        <img
                        ...
                        <div className="ml-4 flex-1">
                          ...
                          <div className="flex items-center mt-2">
                            <span className="mr-2">Quantity: {item.count}</span>
